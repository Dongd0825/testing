...
exports['compile runtime call'] = function (test) {
    compile('puts "Hello, world"', 'var $chai = require("chai"); var puts = $chai.runtime.puts; puts("Hello, world");', test);
};
...
exports['compile while expressions'] = function (test) {
    ...
    compile('while true\nputs 1\nend', 'var $chai = require("chai"); var puts = $chai.runtime.puts; while (true) puts(1);', test);
};
